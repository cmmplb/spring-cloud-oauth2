...
````shell
curl --location 'http://localhost:20000/oauth/check_token?token=15e967ed-312d-405b-a390-3755321c9164'
````
...
````shell
curl --location 'http://localhost:20000/oauth/check_token?token=70bf3f24-8915-45ed-94bb-673d15d0989e'
````
